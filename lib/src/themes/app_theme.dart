...
class AppTheme{
  static const Color lightGreen =Color(0xffD6F3D9);
  static const Color lightBlack = Color(0xff686464);
  static const Color black =Colors.black;
  static const Color white =Colors.white;
  static const Color primary = Color(0xff46B552);

  static const  Color greyMessageColor = Color(0xffA9A9A9);
  ...
  static const Color restrict = Color(0xffB9C52E);
  static const Color ban  = Color(0xffDB1616);
  static const Color black3 = Color(0xff3C3A3A);
  static const Color backgroundColor = Color(0xffF5F5F5);
  static const Color yellow = Color(0xffFFED47);

  static const Color grey =Color(0xffD7D3D3);
